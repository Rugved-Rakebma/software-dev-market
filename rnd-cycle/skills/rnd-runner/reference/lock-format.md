...
- gate: clean tree on main, all branches deleted
...
- [ ] 3.2 merge feature/run-{run-id}-04-02 → main (no-ff) — cache types first
- [ ] 3.3 merge feature/run-{run-id}-04-01 → main (no-ff)
- [ ] 3.4 merge feature/run-{run-id}-04-03 → main (no-ff)
- [ ] 3.5 delete worktrees and branches
- [ ] 3.6 commit checkpoint: "build({scope}): merge plans 04-01..03"
- gate: clean tree on main, no orphan branches/worktrees
